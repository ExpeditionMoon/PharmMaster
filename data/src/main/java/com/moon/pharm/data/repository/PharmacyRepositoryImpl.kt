...
class PharmacyRepositoryImpl @Inject constructor(
    ...
    private fun Throwable.toPharmacyException(): PharmacyException = when (this) {
        is FirebaseFirestoreException -> when (code) {
            FirebaseFirestoreException.Code.NOT_FOUND -> PharmacyException.NotFound()
            else -> PharmacyException.NetworkError()
        }
